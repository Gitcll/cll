...
<html>
  <head>
	...
	<link rel="icon" href="manager/img/logo/logo64.ico"/>
	<!--
    ...
    <script type="text/javascript" color="255,0,60" opacity='0.7' zIndex="-2" count="99" src="//cdn.bootcss.com/canvas-nest.js/1.0.1/canvas-nest.min.js"></script>
    	<div class="head">
    		...
    		<div class="head_bottom">
    			<strong name="index_name">${backname}${type}<span>,您好!</span></strong>
    		</div>
    	</div>
    	...
    	<div class="content">
    		<div class="content_left">
    			<ul>
    				...
    				<li><a href="/hospital/pageGuahao?page=1" target="screen">挂号管理</a></li>
    				<li><a href="/hospital/PageChuFangServlet?page=1" target="screen">处方管理</a></li>
    				<li><a href="/hospital/findd?page=1" target="screen">医生管理</a></li>	
